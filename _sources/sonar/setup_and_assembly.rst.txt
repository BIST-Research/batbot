...
The amplifier takes in a voltage output from the ItsyBitsy and amplified through the PCB board. It then amplifies the signal further and outputs it through the transducer. 
The green LED on the amplifier’s board indicates that it is on and receiving power. Diagrams and schematics regarding the amplifier and the PCB it sits on can be found in the Fusion drive, in the Electronics folder. 
...
TODO: Describe how to select a target and position the system relative to it.
